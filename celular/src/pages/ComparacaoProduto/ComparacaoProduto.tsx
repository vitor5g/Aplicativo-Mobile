...
const Produto: React.FC<NavigationProps> = ({ route, navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Text style={styles.nomeCesta}>Produtos Cesta</Text>
                ...
                {produtos.map((produto: ProdutoModel) => {
                    return (
                        <View style={{ marginTop: 0, backgroundColor: 'white', width: 310 }}>
                            {produto.id % 2 == 0 && (
                                <TouchableOpacity style={[styles.inputBlock, { backgroundColor: '#ffcc00' }]} key={produto.id} >
            ...
            <Text style={[styles.nomeCesta, { marginTop: -60, marginBottom: 30 }]}>Produtos NFC-e</Text>
            <ScrollView
                style={styles.notaList}
                contentContainerStyle={{
                    paddingHorizontal: 16,
                    paddingBottom: 16,
                    alignContent: 'center'
                        ...
                        <View style={{ marginTop: 0, backgroundColor: 'white', width: 310 }}>
                            ...
                            {produto.id % 2 == 0 && (
                                <TouchableOpacity style={[styles.inputBlock, { backgroundColor: '#ffcc00' }]} key={produto.id} >
                                    ...
                                    <View style={styles.information}>
                                        <Text style={styles.description}>{produto.descricao}</Text>
                                        <Text style={styles.price}> <Text style={{ color: '#6a6180', fontSize: 10, fontFamily: 'Poppins_400Regular', }}>UN</Text> R$ {(produto.preco + 2).toFixed(2).toString().replace(".", ",")} </Text>
                                        <Text style={[styles.price, { textAlign: 'right', flexDirection: 'row', color: '#d3040e' }]}>  R$ {(produto.quantidade * produto.preco).toFixed(2).toString().replace(".", ",")} <Text style={{ color: '#6a6180', fontSize: 10, fontFamily: 'Poppins_400Regular', }}> TOTAL </Text> </Text>
                                    </View>
                                </TouchableOpacity>
                            )}
